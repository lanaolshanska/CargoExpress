...
INSERT INTO Warehouse(City, State) VALUES
('New York','New York'),
...
INSERT INTO Truck(Brand, Number, Year, Payload, FuelConsumption, Volume) VALUES
...
INSERT INTO Driver(FirstName, LastName, Birthdate) VALUES
('John','Doe','01/23/67'),
('Adam','Petr','05/23/75'),
...
INSERT INTO Contact (FirstName,LastName,CellPhone) VALUES
...
INSERT INTO Route(OriginWarehouseId, DestinationWarehouseId, Distance)
SELECT WarehouseOrigin.WarehouseId, WarehouseDest.WarehouseId, ABS(CHECKSUM(NEWID()) % 3000) + 100
FROM Warehouse WarehouseOrigin
RIGHT JOIN Warehouse WarehouseDest 
...
BEGIN
SET @i = @i + 1
SET @senderId = (SELECT TOP 1 ContactId FROM Contact ORDER BY NEWID())
SET @recipientId = (SELECT TOP 1 ContactId FROM Contact ORDER BY NEWID())
SET @routeId = (SELECT TOP 1 RouteId FROM Route ORDER BY NEWID())
SET @driverId = (SELECT TOP 1 DriverId FROM Driver ORDER BY NEWID())
...
INSERT INTO Cargo(RouteId, Weight, Volume, SenderContactId, RecipientContactId, Status, DriverId) VALUES(
@routeId,
